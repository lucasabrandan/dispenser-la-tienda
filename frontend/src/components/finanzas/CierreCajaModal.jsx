            ...
            <div className="w-full md:max-w-lg rounded-t-3xl md:rounded-3xl max-h-[90vh] flex flex-col bg-card shadow-2xl"
                ...
                <div className="px-5 pt-5 pb-4 border-b border-black/[0.07] dark:border-white/[0.07] flex-shrink-0">
                    ...
                    <div className="flex items-start justify-between">
                        <div>
                            <h3 className="text-body-lg font-black uppercase tracking-tighter text-ink">
                                Cierre de Caja
                            </h3>
                            <p className="text-caption text-muted mt-0.5">Resumen del período</p>
                        </div>
                        ...
                        <>
                            ...
                            <div className="rounded-2xl overflow-hidden border border-black/[0.07] dark:border-white/[0.07]">
                                <div className="p-4 bg-[#1C1917] dark:bg-[#0F0F0F]">
                                    <p className="text-label font-bold uppercase tracking-widest text-white/50 mb-1">Resultado neto</p>
                            ...
                            {porTecnico.length > 0 && (
                                <>
                                    <p className="text-label font-bold uppercase tracking-widest text-muted px-1">Liquidación por técnico</p>
                                    {porTecnico.map(tec => {
                            ...
                            {gastos.length > 0 && (
                                <>
                                    <p className="text-label font-bold uppercase tracking-widest text-muted px-1">Gastos del período</p>
                                    <div className="rounded-2xl overflow-hidden border border-black/[0.07] dark:border-white/[0.07]">
                                        {gastos.map((g, i) => (
                                        ...
                                        <div className="flex justify-between px-4 py-2 bg-panel text-body">
                            ...
                            {servicios.length > 0 && (
                                <>
                                    <p className="text-label font-bold uppercase tracking-widest text-muted px-1">Detalle servicios</p>
                                    <div className="rounded-2xl overflow-hidden border border-black/[0.07] dark:border-white/[0.07]">
                                        {servicios.map(s => (
                            ...
                            {ventas.length > 0 && (
                                <>
                                    <p className="text-label font-bold uppercase tracking-widest text-muted px-1">Detalle ventas</p>
                                    <div className="rounded-2xl overflow-hidden border border-black/[0.07] dark:border-white/[0.07]">
                                        {ventas.map(v => (
