    ...
    return (
        <div className="bg-chip p-4 rounded-xl border border-black/[0.08] dark:border-white/[0.08] space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    <label className="text-xs font-black text-muted uppercase tracking-wide">Calle *</label>
                ...
                <div>
                    <label className="text-xs font-black text-muted uppercase tracking-wide">Número *</label>
                    <input type="text" name="numero" value={formData.numero} onChange={handleChange}
                        placeholder="Ej: 3400" className={inputClass('numero')} />
                </div>
                <div>
                    <label className="text-xs font-black text-muted uppercase tracking-wide">Piso (opcional)</label>
                ...
                <div>
                    <label className="text-xs font-black text-muted uppercase tracking-wide">Depto (opcional)</label>
                    <input type="text" name="depto" value={formData.depto} onChange={handleChange}
                        placeholder="Ej: A"
                        className="w-full p-3 mt-2 rounded-xl border-2 border-black/[0.08] dark:border-white/[0.08] bg-card text-ink" />
                </div>
                <div>
                    <label className="text-xs font-black text-muted uppercase tracking-wide">Localidad *</label>
                ...
                <div>
                    <label className="text-xs font-black text-muted uppercase tracking-wide">Provincia</label>
            ...
            {formData.direccion && (
                <div className="p-3 bg-[var(--blue-bg)] rounded-lg border border-[var(--blue-tx)]/20">
                    <p className="text-xs text-[var(--blue-tx)] font-bold flex items-center gap-1.5">
