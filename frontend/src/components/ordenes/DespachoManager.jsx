...
import { LuClipboardList, LuHourglass, LuCar, LuMapPin, LuCircleCheck, LuUser, LuSettings2 } from 'react-icons/lu';
...
// PRIORIDAD_COLOR, ESTADO_COLOR, SIGUIENTE_ESTADO_ADMIN y OrdenCard se mudaron a
// ./OrdenCard.jsx (hub único de Servicio Técnico — ítem 4 paso 3 / ítem 17 opción 3):
// ServicioManager.jsx también necesita esta misma tarjeta para sus tabs
// Pendientes/En camino/En sitio (fusionadas desde acá), así que ahora vive como
// pieza compartida en vez de duplicarse entre las dos pantallas.
