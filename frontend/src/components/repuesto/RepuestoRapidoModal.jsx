                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <div className="flex gap-3 mt-1">
                        <button
                            ...
                            className="flex-1 py-3.5 rounded-xl font-black text-sm bg-chip text-ink active:scale-95 transition-all disabled:opacity-50"
                        >
                            Cancelar
                        </button>
                        <button
                            type="submit" disabled={cargando}
                            className="flex-[2] py-3.5 rounded-xl font-black text-sm text-white bg-brand-red active:scale-95 transition-all disabled:opacity-50"
                        >
