...
export default function AlertasBlock({ pptoVencidos, ordenesActivas, alertasRadar, setVistaActual }) {
    ...
    return (
        <div>
            <p className="text-label font-bold uppercase tracking-wider text-muted mb-2">Alertas ({total})</p>
                ...
                {pptoVencidos.length > 0 && (
                    <button onClick={() => setVistaActual('presupuestos')}
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-caption text-[#D13A28]/60 dark:text-[#F87171]/60 truncate">
                ...
                {ordenesActivas.length > 0 && (
                    <button onClick={() => setVistaActual('despacho')}
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-caption text-[#92400E]/60 dark:text-[#FBBF24]/60 truncate">
