...
export default function VentaStats({ stats }) {
    return (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
            ...
            {/* Facturado el mes */}
            <div className="bg-[#FFFFFF] dark:bg-[#242424] p-4 rounded-2xl border border-black/[0.07] dark:border-white/[0.07] border-l-[3px] border-l-[#D13A28]">
            ...
            {/* Hoy */}
            <div className="bg-[#FFFFFF] dark:bg-[#242424] p-4 rounded-2xl border border-black/[0.07] dark:border-white/[0.07]">
